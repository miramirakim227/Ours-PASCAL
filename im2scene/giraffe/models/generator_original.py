...
class Generator(nn.Module):
    ...
    def __init__(self, device, z_dim=256, z_dim_bg=128, decoder=None,
                 ...
                 range_radius=(0.5, 0.5), depth_range=[0., 1.],
        ...
        self.range_v = range_v
        self.range_u = range_u
        self.camera_loss = losses.camera_loss
    ...
    def volume_render_image(self, latent_codes, camera_matrices,
        ...
        # 카메라 축이 어디인지를 알아야 그거에 맞게 +-가 가능할듯,, 그렇지 않으면 4가지 경우의 수 다 봐야할 듯.. 
        # Arange Pixels
        ...
        # for orthographic matrix: assert ray_vector : parallel (방향만 다르고 전부 Parallel)
        di = depth_range[0] + \
